    ...
    <div className="marking-container">
      ...
      <div style={{ backgroundColor: "white" }}>
        <div className="t-list-head-container">
          <label className="h-text">
            {" "}
            <label style={{ color: "#FF5631" }}> CREATE</label> MARKING
          </label>{" "}
          <br className="br1" />
        ...
        <div className="m-from-container">
          ...
          <form>
            ...
            <div className="m-sub">
              <div className="m-sub-container">
                <div className="mb-3">
                  <label className="m-form-label" style={{ color: "#322B5F" }}>
                    Scheme Type
                  </label>
                  <select
                    className="form-control m-select"
          ...
          <button
            className="btn l-btn-accepted "
            style={{ width: "200px", fontWeight: "bold", marginLeft: "20px" }}
      ...
      <div style={{ backgroundColor: "#D5D3E2" }}>
        <div className="t-list-head-container">
          <label className="h-text">
            {" "}
            <label id="pCon" style={{ color: "#FF5631" }}>
              {" "}
              {100 -
                criteria
                  ?.map((data) => Number(data.mark.replace("$", "")))
